...
class info(commands.Cog):
    ...
    async def invite(self , ctx):
        ...
        embed1 = discord.Embed(title="Invite", description="Test", color=0x2F3136)
        embed1.add_field(title="Invite", value="🌐 [Invite Link](https://discord.com/oauth2/authorize?client_id=751447995270168586&permissions=268823638&redirect_uri=https%3A%2F%2Fastrobot.carrd.co%2F&response_type=code&scope=bot%20identify)", inline=False)
        embed1.add_field(title="Support Server", value="<:discord:765251798629220382> [Support Server](https://discord.gg/7yZqHfG)", inline=False)
        embed1.add_field(title="<:info:758451109919981580> Contact", value="To contact either dm @isirk#0001, email us @isirk@asksirk.com or join our [Support Server.](https://discord.gg/7yZqHfG)", inline=False)
        embed1.set_thumbnail(url="https://cdn.discordapp.com/avatars/751447995270168586/103a763a727a393b9357df35102a638d.webp?size=1024")
