...
class info(commands.Cog):
    ...
    async def privacy(self, ctx):
        embed = discord.Embed(title="Privacy Policy for Astro", description="Astro strives to store no data to make astro as simple to use as possible. The warn, kick, and ban commands store a users ID for about 1 second. Other than that nothing is stored/recorded/or anything else.\n\n<:tab:758139554842148934> [Privacy Policy](https://asksirk.com/Astro/privacy/)", color=0x2F3136)
