...
class info(commands.Cog):
    ...
    async def source(self, ctx):
        await ctx.send("<:python:758139554670313493> You can see my source here -> https://asksirk.com/Astro/github.html")
    ...
    async def help(self, ctx, *, page=None):
        ...
        helpembed1.add_field(name= "<:help:758453150897799172> Help", value="React below to change the pages.\n**Note:**\nYou can type `help <page name>` to get a specific help page.", inline=False)
        helpembed1.add_field(name="<:post:726779670770483240> Pages", value="```yaml\n1) Info\n2) Utility\n3) Mod\n4) Other\n```", inline=False)
