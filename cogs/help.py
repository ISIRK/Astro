...
class GroupHelpPageSource(menus.ListPageSource):
    ...
    async def format_page(self, menu, commands):
        ...
        embed.set_footer(text=f'Use {self.prefix}help [command|module] for more info on a command.')
        return embed
...
class HelpMenu(RoboPages):
    ...
    async def show_bot_help(self, payload):
        ...
        embed.add_field(name='How do I use this bot?', value='To use the bot type `^help` for a list of commands\nAnd then `^<command>` to use a command.')
    ...
    async def show_bot_help(self, payload):
        ...
        embed.add_field(name="Info", value="To contact dm [isirk#0001](https://discord.com/users/542405601255489537) or join [our support server](https://discord.gg/7yZqHfG).")
        embed.set_footer(text=footer)
        await self.message.edit(embed=embed)
